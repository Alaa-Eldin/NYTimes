...
protocol Popupable  {
    ...
    func showPopup(title: String, message: String, okTitle:String, cancelTitle: String, completion:@escaping (() -> Void))
    func showPopup(title: String, message: String, okTitle:String, cancelTitle: String, OkCompletion:@escaping (() -> Void), CancelCompletion:@escaping (() -> Void))
}
...
extension Popupable where Self:UIViewController{
    ...
    func showPopup(title: String, message: String, cancelTitle: String, completion:@escaping (() -> Void)){
        let alert = UIAlertController(title: title, message: message, preferredStyle: .alert)
        alert.addAction(UIAlertAction(title: cancelTitle, style: .cancel, handler: { (alertAction) in
            completion()
        }))
        self.present(alert, animated: true, completion: nil)
    }
